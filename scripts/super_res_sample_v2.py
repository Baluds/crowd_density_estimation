    ...
    for _ in os.listdir(args.data_dir):
        ...
        while data_parameter.resample:
            ...
            for iter in count:
              ...
              print(data_parameter.crowd_count[data_parameter.crowd_count>0].shape)
              print(iter.shape)

              # _ = np.stack([data_parameter.crowd_count[data_parameter.crowd_count>0],iter])
              _ = np.stack([data_parameter.crowd_count[data_parameter.crowd_count > 0].reshape(1, 1), iter])
